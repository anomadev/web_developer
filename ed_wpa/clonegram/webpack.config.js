...
module.exports = {
  ...
  plugins: [
    ...
    new WebpackPwaManifest({
      name: 'Clonegram por anomadev',
      short_name: 'Clonegram',
      description: 'Aplicacion web progresiva inspirada en instagram con fines educativos',
      ...
      icons: [
        {
          src: path.resolve('src/assets/img/clonegram-icon-black.png'),
